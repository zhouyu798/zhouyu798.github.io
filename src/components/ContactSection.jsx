...
export default function ContactSection() {
  return (
    <section id="contact" className="content-auto relative flex min-h-screen items-center overflow-hidden px-5 py-28">
      <motion.div
      ...
      >
        ...
        <div className="mt-10 flex flex-wrap justify-center gap-4">
          <a href="/images/portfolio/resume.png" download className="inline-flex items-center gap-2 rounded-full bg-ink px-6 py-4 text-sm font-semibold text-white shadow-card transition hover:bg-harmony">
